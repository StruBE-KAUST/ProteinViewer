...
AFRAME.registerComponent('collider', {
  ...
  tick: (function () {
    ...
    return function () {
      ...
      // No collisions.
      if (collisions.length === 0) { self.el.emit('hit', {el: null}); /*self.el.sceneEl.querySelector('[camera]').emit('collide', {el: null});*/ }
      ...
      function handleHit (hitEl) {
        ...
        //self.el.sceneEl.querySelector('[camera]').emit('collide', {el: null});
      }
